...
export const projects = [
  ...
  // {
  //   id: 1,
  //   name: "Responsive Restaurant UI Design ",
  //   description:
  //     "Created a responsive UI design for a restaurant website during a college event, earning 1st position for outstanding creativity and user experience.",
  //   href: "https://www.figma.com/proto/hhodWDLoNDGPUfDk7KZtKg/RESTAURANT-UI?node-id=106-2&t=FT92emxtiUpBwMtZ-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=106%3A2&show-proto-sidebar=1",
  //   image: "/assets/projects/restaurant.png",
  //   bgImage: "/assets/backgrounds/blanket.jpg",
  //   frameworks: [{ id: 1, name: "Figma" }],
  // },
  // {
  //   id: 2,
  ...
  //   description:
  //     "Designed and developed a modern, responsive UI for the college website redesign project, focusing on improved usability and visual consistency.",
  //   href: "https://www.figma.com/proto/q764X75mi7xtuy8LftYhdm/NIT-JAMSHEDPUR?node-id=700-4299&p=f&t=iqTqqUsdx4qDrJ5F-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=700%3A4299",
  //   image: "/assets/projects/college.png",
  //   bgImage: "/assets/backgrounds/blanket.jpg",
  //   frameworks: [{ id: 1, name: "Figma" }],
  // },
  // {
  ...
  //   description:
  //     "Designed a custom souvenir for a freelance project, blending creative visuals with personalized branding to deliver a memorable keepsake.",
  //   href: "https://drive.google.com/file/d/19cSsy3Phv6_LaJhsWrx5VodO039iNwEk/view?usp=sharing",
